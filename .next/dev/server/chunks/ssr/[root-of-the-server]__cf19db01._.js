...
const fetchLaundryInfo = async ()=>{
    const response = await api.get(`/api/public/laundry/${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["laundryConfig"].slug}/info`);
    return response.data;
};
const fetchProducts = async ()=>{
    const response = await api.get(`/api/public/laundry/${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["laundryConfig"].slug}/products`);
    return response.data;
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf19db01._.js.map